...
virt-clone --original k8sworker --name agent1 --file /var/kvm/images/agent1.img --replace
...
virt-clone --original k8sworker --name agent2 --file /var/kvm/images/agent2.img --replace
